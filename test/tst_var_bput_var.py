...
class VariablesTestCase(unittest.TestCase):
    ...
    def test_cdf5(self):
        """testing variable bput var all for CDF-5 file format"""
    ...
    def test_cdf2(self):
        """testing variable bput var all for CDF-2 file format"""
    ...
    def test_cdf1(self):
        """testing variable bput var all for CDF-1 file format"""
