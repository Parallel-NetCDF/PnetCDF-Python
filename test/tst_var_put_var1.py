...
class VariablesTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        v1_u = f.def_var('data1u', pnetcdfpy.NC_INT, ('xu','y','z'))
        v2_u = f.def_var('data2u', pnetcdfpy.NC_INT, ('xu','y','z'))
        ...
        f = pnetcdfpy.File(filename=self.file_path, mode = 'r+', format=self._file_format, comm=comm, info=None)
